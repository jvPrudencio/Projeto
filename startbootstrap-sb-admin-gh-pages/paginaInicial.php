  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
         <!--Pagina 2-->
            <a>Como Obeter Remedios Gratuitamente</a>
        </ol>
        <br>
        ...
        <br>
        <br>
        <h2><b>Saiba como adquirir</b></h2><br>
        <ul>
            <li>Acesse a relação de fármacos e veja se o remédio que o médico prescreveu está na lista: Grupo 1, Grupo 2 e Grupo 3.</li>
            <li>Tenha o Cartão Nacional de Saúde (CNS) em mãos. O cidadão que ainda não possui o cartão pode fazer um pré-cadastro e gerar um protocolo de atendimento no Portal Saúde do Cidadão. Pelo site, o usuário pode consultar o cadastro, imprimir o cartão, verificar o Registro de Ações e Serviços de Saúde. Contudo, o Ministério da Saúde reforça que, mesmo sem o cartão, o paciente pode ter acesso aos remédios.</li>
            <li>Compareça até a farmácia do Centro de Saúde mais próximo com o CNS, documento de identificação e a receita médica (SUS ou particular) e solicite a medicação. Pode ser retirada pelo usuário ou responsável legal (com apresentação da carteira de identidade).</li>
        </ul>
