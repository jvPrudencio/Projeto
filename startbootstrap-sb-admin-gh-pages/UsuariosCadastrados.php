...
?>
    <tr>
        ...
        <td>
             <a href=" <?php echo "atualizacaoCadastro.php?id=" . $linha['id'] . "&nome" . $linha['nome']. "&email" . $email['email'] . "&cep" . $linha['cep'] . "&endereco" . $linha['endereco'] . "&bairro" . $linha['bairro'] . "&localide". $linha['localidade'] ?>" >Editar</a>
            <a href="  <?php echo "excluirUsuario.php?id=" . $linha['id']  ?>" > Excluir</a>
        </td>
    </tr>
