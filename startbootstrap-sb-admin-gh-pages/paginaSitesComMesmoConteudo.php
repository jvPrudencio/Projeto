  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <a href="paginaSitesComMesmoConteudo.php"><h6>Projetos Parecidos</h6></a><br>
        </a>
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
        <!--Pagina 6--> 
            <a>Sites com o mesmo conteudo</a>
        </ol>
        <br>
            <h2><b>Sites que fornecem o mesmo conteudo</b></h2><br>
            <a href="http://portalms.saude.gov.br/acoes-e-programas/farmacia-popular"><h6>Farmacia Popular</h6></a>
            <a href="https://consultaremedios.com.br/"><h6>Farmacia Popular</h6></a>
            <a href="http://www.drogacenter.com.br/conteudo/veja-como-conseguir-remedios-de-graca-independentemente-da-sua-renda.html"><h6>DrogaCenter</h6></a>
